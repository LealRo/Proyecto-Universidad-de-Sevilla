...
require_once '../src/rooms-history.php';
?>
...
<html lang="en">
    ...
    <div class="container-fluid" id="tablaSalas">
        <div class="row">
            <div class="col-sm-8">
                <h1 class="display-4" style="font-size: 30px">Respuestas de la sala #<?php echo $_GET["idSala"]; ?></h1>
            </div>
        </div>
        <hr>
        <br>
        ...
        <hr>
        <br>  
        <a href="rooms-table.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Regresar</a>       
