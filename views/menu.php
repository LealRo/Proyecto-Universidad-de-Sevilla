            ...
            <div class="container">
                ...
                <div class="col-md-3" style="">
                    <div class="col-md-9" style="	background-image: url(color.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
                        <ul class="list-group">
                            <li class="border-0 list-group-item d-flex justify-content-between align-items-center" style="	background-image: url(color.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;"><br><a class="btn btn-outline-success" href="elige_cuento.html">Mis clases</a><img class="img-fluid d-block mx-auto" src="../public/img/004-ordenador-portatil.png" height="25%" width="25"><i></i></li>
